...
Tags: confirmation page, confirm age, show message, confirmation message
Requires at least: 3.0
Tested up to: 3.3
Stable tag: 0.1

Plugin that displays an age confirmation page on home of your blog

== Description ==

With that plugin, your visitor must confirm that they are more than 18 years old to access your main blog page (home)
...
Yes you can, just leave a reaply at [Confirm Age](http://blogwordpress.ws/plugin-confirm-age#comments)
